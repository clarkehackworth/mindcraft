...
// to carry the four fields that have actually decided a rule -- cause, place,
// night or day, armed or not -- and the harness parses it with grep, so the
// shape matters as much as the content.
